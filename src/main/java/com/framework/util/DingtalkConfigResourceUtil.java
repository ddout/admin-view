 ...
 * 
 */
public class DingtalkConfigResourceUtil {

    private static final ResourceBundle bundle = java.util.ResourceBundle.getBundle("conf/dingtalkConfig");
	...
	return StringUtils.trimToEmpty(domain).equals(DingtalkConfigResourceUtil.getConfigByName("admin_domain"))
		|| admin != null;
    }
